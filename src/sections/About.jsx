  ...
  return (
    <section id="about">
      <div className="container">
        <div className="flex flex-col-reverse lg:flex-row itmes-center justify-between gap-8">
          {/* Left Side */}
          <motion.div
          ...
          >
            <div className="flex flex-col gap-y-4">
              ...
              <p className="text-base font-medium text-gray-60">
                ...
                unde rerum nobis pariatur, ipsum maxime quidem quis accusamus
                tenetur dolorum at ducimus amet maiores debitis, enim saepe
                neque laudantium consectetur.
              </p>
            </div>
            <div className="flex flex-wrap justify-center gap-4">
              {aboutFeaturs.map((feature) => (
                ...
                >
                  ...
                  <p className="text-base font-medium text-gray-60 !leading-[normal] group-hover:text-gra-90">
                    {feature.description}
                  </p>
                </div>
              ))}
