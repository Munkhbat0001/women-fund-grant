...
const Instructor = ({ id, name, specialty, pic, rating }) => {
  return (
    <div
      className="group flex flex-col gap-y-4 rounded-4xl border border-solid border-transparent hover:border-gray-10 transition-colors duration-300 "
      data-id={id}
    >
        ...
        <div className="flex flex-col">
          <div className="flex justify-between">
            ...
            <div className="flex items-center gap-x-1.5">
              ...
              <p className="text-base text-gray-10"></p>
            </div>
          </div>
